...
%readmore`.trimStart(),
  ...
  after: `
Dream∆Bot By Rhmd
${'```Dream∆Bot Adalah Bot Whatsapp Ringan```'}
`,
}
...
⛧ Database: ${rtotalreg} dari ${totalreg}`.trim(),
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch(fla + teks)).buffer(), text.trim(), 'Made With 💓 By Rhmd', 'Pemilik Bot', '.owner', 'Donasi', '.donasi', m)
  } catch (e) {
