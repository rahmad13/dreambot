  ...
  async handler(chatUpdate) {
    ...
    ayam: 0,
        ...
        if (chat) {
          ...
          if (!isNumber(chat.expired)) chat.expired = 30
...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'Emangnya Lu Tuan Gua?',
    owner: 'Emangnya Lu Tuan Gua?',
    mods: 'Perintah ini hanya dapat digunakan oleh _*Moderator*_',
    premium: 'Ingat, Lu tuh cuman user gratisan \nNih fitur khusus user *Premium*',
    group: 'Emangnya Ini Grup?',
    private: 'Emangnya Ini Chat Pribadi?',
    admin: 'Jabatan lu apaan?, Kok sampek nyuruh² gua. \nInikan Fitur khusus *Admin*',
    botAdmin: 'Gak Punya Mata Ya? \n Gua kan bukan *Admin* ',
    unreg: 'Silahkan daftar untuk menggunakan fitur ini dengan cara mengetik:\n\n*#daftar nama.umur*\n\nContoh: *#daftar rhmd.17*',
